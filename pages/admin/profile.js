...
import { User, Mail, Lock, Eye, EyeOff, Save, LogOut, X, Shield, ShieldCheck } from 'lucide-react'
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="px-5 pb-5 -mt-8 flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-xl bg-indigo-700 ring-4 ring-white dark:ring-gray-800 flex items-center justify-center text-white text-2xl font-extrabold shrink-0">
                  {name.charAt(0)}
                </div>
                <p className="font-bold text-gray-900 text-lg mt-3">{name}</p>
                <p className="text-sm text-gray-500 break-all">{email}</p>
                <span className="inline-flex items-center gap-1 mt-3 px-2.5 py-0.5 bg-indigo-100 text-indigo-700 rounded-full text-xs font-semibold">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSave} className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 sm:p-6 space-y-4">
              <h2 className="font-bold text-gray-800 text-sm">Edit Information</h2>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-xl border border-gray-200 shadow-md w-full max-w-sm z-10 p-6">
            <div className="flex items-start justify-between mb-4">
              ...
              <button onClick={() => setShowLogoutConfirm(false)} aria-label="Close" className="p-1 rounded-lg hover:bg-gray-100 text-gray-400 transition-colors">
                <X size={16} />
              </button>
            </div>
